          ...
          <tr v-for="company in filteredCompanies" :key="company.id">
            ...
            <td class="text-right">
              <div class="action-buttons">
                <button class="action-btn edit" @click="openModal(company)" title="Редактировать">✏️</button>
                <button class="action-btn delete" @click="handleDelete(company.id)" title="Удалить">🗑️</button>
              </div>
            </td>
          </tr>
        </tbody>
