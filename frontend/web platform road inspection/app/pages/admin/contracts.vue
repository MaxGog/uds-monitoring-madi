          ...
          <tr v-for="contract in filteredContracts" :key="contract.id">
            ...
            <td class="text-right">
              <div class="action-buttons">
                <button class="action-btn edit" @click="openModal(contract)" title="Редактировать">✏️</button>
                <button class="action-btn delete" @click="handleDelete(contract.id)" title="Удалить">🗑️</button>
              </div>
            </td>
          </tr>
        </tbody>
